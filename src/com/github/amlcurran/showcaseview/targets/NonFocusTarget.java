 ...
 */
public class NonFocusTarget implements Target {
    ...
    public NonFocusTarget(View view, int viewsharp, String descript, ArrowObject arrow, String targetID) {
        mView = view;
    ...
    public NonFocusTarget(int viewId, int viewsharp, String descript, Activity activity, ArrowObject arrow, String targetID) {
